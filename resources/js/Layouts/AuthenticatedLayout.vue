                    ...
                    <div class="flex h-16 justify-between">
                        <div class="flex">
                            ...
                            >
                                ...
                                <!-- Menu Khusus Peserta -->
                                <NavLink
                                    v-if="$page.props.auth.user.role === 'peserta'"
                                    :href="route('peserta.galeri')"
                                    :active="route().current('peserta.galeri')"
                                >
                                    🖼️ Galeri Saya
                                </NavLink>
                                <NavLink
                                    v-if="$page.props.auth.user.role === 'peserta'"
                                    :href="route('peserta.upload')"
                                    :active="route().current('peserta.upload')"
                                >
                                    📤 Upload Karya
                                </NavLink>
